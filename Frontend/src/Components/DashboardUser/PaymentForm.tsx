        ...
        <div className="flex gap-4 flex-wrap">
          {services.map(service => (
            <Card
              key={service.value}
              hoverable
              className={`w-72 cursor-pointer ${selectedService === service.value ? 'border-2 border-blue-500' : 'border border-gray-300'}`}
