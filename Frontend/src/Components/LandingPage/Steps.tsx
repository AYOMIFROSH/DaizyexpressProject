	...
	return (
		<div className="bg-[#001829] px-5 py-20">
			<div className="max-w-[1240px] space-y-20 mx-auto">
				<div>
					<h2 className="text-yellow-300 font-semibold text-[18px]">
						HOW IT WORKS
					</h2>
				...
				<div className="grid gap-10  lg:grid-cols-3">
					<div className="lg:space-y-4 space-y-2">
						<img src={Img1} alt="" />
						<p className="text-yellow-300 font-medium">Step 1</p>
					...
					<div className="lg:space-y-4 space-y-2">
						<img src={Img2} alt="" />
						<p className="text-yellow-300 font-medium">Step 2</p>
					...
					<div className="lg:space-y-4 space-y-2">
						...
						<p className="text-yellow-300 font-medium">Step 3</p>
						<h3 className="lg:text-[28px] text-[22px] text-white font-semibold">
