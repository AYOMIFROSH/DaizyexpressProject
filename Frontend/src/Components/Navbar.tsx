...
const Navbar = () => {
	...
	return (
		...
		>
			...
			<HiOutlineMenuAlt4 onClick={() => setNav(true)} className="size-8 lg:hidden" />
			<div className="pr-5 lg:flex hidden items-center gap-x-10">
				...
				<div className="flex items-center gap-x-5">
					...
					<button
						...
						className="px-5 py-2.5 rounded-[5px] bg-yellow-400 font-semibold"
					>
						Get started
					</button>
				</div>
			...
			<div className={`fixed top-0 ${nav ? 'translate-x-0' : 'translate-x-[120vw]'} duration-500 left-0 px-10 w-full h-screen bg-white`}>
				<LiaTimesSolid
				...
				<div className="flex flex-col pt-8 items-center gap-y-3">
					...
					<button
						onClick={() => navigate("/register")}
						className="px-5 py-2.5 w-full rounded-[5px] bg-yellow-400 font-semibold"
					>
						Get started
					</button>
				</div>
